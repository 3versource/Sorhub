...
LANGUAGE = {
	...
	optHideThestral = "Hide HUD",
	optdHideThestral = "Hide your health, armor, needs, and stamina.",
	optAutoHideThestral = "Auto-hide HUD",
	optdAutoHideThestral = "Automatically hide your HUD when values are optimal.",
	optStaminaDrainsThestral = "Stamina Drains from Side",
	optdStaminaDrainsThestral = "Stamina will drain from the side of its box rather than top-to-bottom.",
	optHealthColorThestral = "Health Indicator Color",
	optdHealthColorThestral = "The color of your health indicator on your HUD.",
	optArmorColorThestral = "Armor Indicator Color",
	optdArmorColorThestral = "The color of your armor indicator on your HUD.",
	optHungerColorThestral = "Hunger Indicator Color",
	optdHungerColorThestral = "The color of your hunger indicator on your HUD",
	optThirstColorThestral = "Thirst Color Indicator",
	optdThirstColorThestral = "The color of your thirst indicator on your HUD.",
	optStaminaColorThestral = "Stamina Indicator Color",
	optdStaminaColorThestral = "The color of your stamina indicator on your HUD.",

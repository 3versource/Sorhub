...
function PLUGIN:SetupActs()
	...
	ix.act.Register("Sit", {"citizen_male", "citizen_female"}, {
		sequence = {"sit_ground", "D2_Coast03_PreBattle_Kneel_Idle", "Roofidle1"},
		untimed = true,
		idle = true
	})
	
	ix.act.Register("ChairSit", {"citizen_male"}, {
		sequence = {"d1_t01_breakroom_sit02","silo_sit", "D1_T01_BreakRoom_Sit01_Idle"},
		untimed = true,
		idle = true
	})

	ix.act.Register("ChairSit", {"citizen_female"}, {
		sequence = {"d1_t02_plaza_sit02","silo_sit", "D1_T03_Sit_Bed_Entry"},
		untimed = true,
		idle = true
	})
